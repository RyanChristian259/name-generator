...
var horseArrayFirstName = {a:'Aston', b:'Bearwood', c:'Castle Vale', d:'HayChomp', e:'Erdington', f:'Frankley', g:'Great Burr', h:'Handsworth', i:'Harborne', j:'Kings Heath', k:'Kingstanding', l:'Ladywood', m:'Moseley', n:'Northfield', o:'Nechells', p:'', q:'Quincy', r:'Ruby', s:'Champ', t:'Tompkins', u:'Winny', v:'Woeley Castle', w:'Winston', x:'Xavier', y:'Yardley', z:'Witton'};

var horseArrayLastName = {a:'Apache', b:'Breeze', c:'Cloud', d:'Dancer', e:'Eclipse', f:'Flash', g:'Gypsy', h:'Hero', i:'Invincible', j:'Jampy', k:'Knight', l:'Lightning', m:'Magic', n:'Noon', o:'Orchid', p:'Persimmon', q:'Quil', r:'Roston', s:'Star', t:'Thunder', u:'Universe', v:'Victor', w:'Wizard', x:'Xanadu', y:'Yellow', z:'Zorro'};
...
superheroArrayLastName = {a:'Thunderbolt', b:'Storm', c:'Dymano', d:'Octopus', e:'Falcon', f:'Munchkin', g:'Doctor', h:'Tornado', i:'Hurricane', j:'Blizzard', k:'Volcano', l:'Dagger', m:'Laser', n:'Meteor', o:'Rocket', p:'Thunder', q:'Lightning', r:'Avenger', s:'Destroyer', t:'Muffin', u:'Cookie', v:'Exterminator', w:'Assassin', x:'Marshmellow', y:'Sausage', z:'Wierdo'};
